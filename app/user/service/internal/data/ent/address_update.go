...
func (au *AddressUpdate) AddUserID(i int64) *AddressUpdate {
	au.mutation.AddUserID(i)
	return au
}

// SetUsername sets the "username" field.
func (au *AddressUpdate) SetUsername(s string) *AddressUpdate {
...
// AddUserID adds i to the "user_id" field.
func (auo *AddressUpdateOne) AddUserID(i int64) *AddressUpdateOne {
	auo.mutation.AddUserID(i)
	return auo
}

// SetUsername sets the "username" field.
func (auo *AddressUpdateOne) SetUsername(s string) *AddressUpdateOne {
