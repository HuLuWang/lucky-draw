...
func (*Address) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case address.FieldUsername, address.FieldMobile, address.FieldAddress:
			values[i] = new(sql.NullString)
		case address.FieldCreatedAt, address.FieldUpdatedAt:
			values[i] = new(sql.NullTime)
		case address.ForeignKeys[0]: // user_address
			values[i] = new(sql.NullInt64)
		default:
	...
	for i := range columns {
		...
		case address.ForeignKeys[0]:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				a.user_address = new(int64)
				*a.user_address = int64(value.Int64)
			}
		}
	}
	return nil
